...
typedef enum {
    ...
    CAR_STATE_MOTOR_TRACK,
    CAR_STATE_MOTOR_NO_YAW,
    CAR_STATE_MOTOR_GRAY_TEST,
...
typedef enum {
    ...
    CAR_EVENT_MOTOR_TRACK_START,
    CAR_EVENT_MOTOR_NO_YAW_START,
    CAR_EVENT_MOTOR_GRAY_TEST_START,
