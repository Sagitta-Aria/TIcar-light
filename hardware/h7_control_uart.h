...
typedef enum {
    ...
    H7_CONTROL_COMMAND_START_GRAY_FOLLOW,
    H7_CONTROL_COMMAND_START_ENCODER,
    H7_CONTROL_COMMAND_START_DRIVE,
    H7_CONTROL_COMMAND_START_DIRECTION,
    H7_CONTROL_COMMAND_START_GRAY,
    H7_CONTROL_COMMAND_START_LINE_FOLLOW,
