...
SYSCONFIG_WEAK void SYSCFG_DL_GPIO_init(void)
{
    ...
    DL_GPIO_initDigitalOutput(STEPPER_CHASSIS_LEFT_EN_IOMUX);
    DL_GPIO_initDigitalOutput(STEPPER_CHASSIS_RIGHT_EN_IOMUX);
    DL_GPIO_initDigitalOutput(STEPPER_GIMBAL_1_EN_IOMUX);
    DL_GPIO_initDigitalOutput(STEPPER_GIMBAL_2_EN_IOMUX);
    ...
    DL_GPIO_clearPins(STEPPER_CHASSIS_RIGHT_STEP_PORT,
        STEPPER_CHASSIS_RIGHT_STEP_PIN);
    DL_GPIO_clearPins(STEPPER_CHASSIS_RIGHT_DIR_PORT,
        STEPPER_CHASSIS_RIGHT_DIR_PIN);
    ...
    DL_GPIO_setPins(STEPPER_CHASSIS_LEFT_EN_PORT,
        STEPPER_CHASSIS_LEFT_EN_PIN);
    DL_GPIO_setPins(STEPPER_CHASSIS_RIGHT_EN_PORT,
        STEPPER_CHASSIS_RIGHT_EN_PIN);
    DL_GPIO_setPins(STEPPER_GIMBAL_1_EN_PORT, STEPPER_GIMBAL_1_EN_PIN);
    DL_GPIO_setPins(STEPPER_GIMBAL_2_EN_PORT, STEPPER_GIMBAL_2_EN_PIN);
#else
    DL_GPIO_clearPins(STEPPER_CHASSIS_LEFT_EN_PORT,
        STEPPER_CHASSIS_LEFT_EN_PIN);
    DL_GPIO_clearPins(STEPPER_CHASSIS_RIGHT_EN_PORT,
        STEPPER_CHASSIS_RIGHT_EN_PIN);
    DL_GPIO_clearPins(STEPPER_GIMBAL_1_EN_PORT, STEPPER_GIMBAL_1_EN_PIN);
    DL_GPIO_clearPins(STEPPER_GIMBAL_2_EN_PORT, STEPPER_GIMBAL_2_EN_PIN);
#endif
    ...
    DL_GPIO_enableOutput(STEPPER_CHASSIS_RIGHT_STEP_PORT,
        STEPPER_CHASSIS_RIGHT_STEP_PIN);
    DL_GPIO_enableOutput(STEPPER_CHASSIS_RIGHT_DIR_PORT,
        STEPPER_CHASSIS_RIGHT_DIR_PIN);
    ...
    DL_GPIO_enableOutput(STEPPER_GIMBAL_2_DIR_PORT,
        STEPPER_GIMBAL_2_DIR_PIN);
    DL_GPIO_enableOutput(STEPPER_CHASSIS_LEFT_EN_PORT,
        STEPPER_CHASSIS_LEFT_EN_PIN);
    DL_GPIO_enableOutput(STEPPER_CHASSIS_RIGHT_EN_PORT,
        STEPPER_CHASSIS_RIGHT_EN_PIN);
    DL_GPIO_enableOutput(STEPPER_GIMBAL_1_EN_PORT,
        STEPPER_GIMBAL_1_EN_PIN);
    DL_GPIO_enableOutput(STEPPER_GIMBAL_2_EN_PORT,
        STEPPER_GIMBAL_2_EN_PIN);
