 ...
 *
 * 当前实车接线：
 * 左轮  STEP PA13，DIR PB24。
 * 右轮  STEP PA12，DIR PA22。
 * YAW   STEP PA7， DIR PB18。
 * PITCH STEP PA8， DIR PA9。
 */
#define PIN_STEPPER_CHASSIS_LEFT_STEP_PORT   STEPPER_CHASSIS_RIGHT_STEP_PORT
#define PIN_STEPPER_CHASSIS_LEFT_STEP        STEPPER_CHASSIS_RIGHT_STEP_PIN
#define PIN_STEPPER_CHASSIS_LEFT_DIR_PORT    STEPPER_CHASSIS_RIGHT_DIR_PORT
#define PIN_STEPPER_CHASSIS_LEFT_DIR         STEPPER_CHASSIS_RIGHT_DIR_PIN
#define PIN_STEPPER_CHASSIS_LEFT_EN_PORT     STEPPER_CHASSIS_RIGHT_EN_PORT
#define PIN_STEPPER_CHASSIS_LEFT_EN          STEPPER_CHASSIS_RIGHT_EN_PIN

#define PIN_STEPPER_CHASSIS_RIGHT_STEP_PORT  STEPPER_CHASSIS_LEFT_STEP_PORT
#define PIN_STEPPER_CHASSIS_RIGHT_STEP       STEPPER_CHASSIS_LEFT_STEP_PIN
#define PIN_STEPPER_CHASSIS_RIGHT_DIR_PORT   STEPPER_CHASSIS_LEFT_DIR_PORT
#define PIN_STEPPER_CHASSIS_RIGHT_DIR        STEPPER_CHASSIS_LEFT_DIR_PIN
#define PIN_STEPPER_CHASSIS_RIGHT_EN_PORT    STEPPER_CHASSIS_LEFT_EN_PORT
#define PIN_STEPPER_CHASSIS_RIGHT_EN         STEPPER_CHASSIS_LEFT_EN_PIN
...
#define PIN_STEPPER_GIMBAL_1_EN_PORT         STEPPER_GIMBAL_1_EN_PORT
#define PIN_STEPPER_GIMBAL_1_EN              STEPPER_GIMBAL_1_EN_PIN
...
#define PIN_STEPPER_GIMBAL_2_EN_PORT         STEPPER_GIMBAL_2_EN_PORT
#define PIN_STEPPER_GIMBAL_2_EN              STEPPER_GIMBAL_2_EN_PIN
